...
const latestTransactionsData = [
  { id: 1, amount: 100, date: "2024-02-05", to: "Arora" },
  { id: 2, amount: 50, date: "2024-02-04", to: "Arora" },
  { id: 3, amount: 100, date: "2024-02-05", to: "Arora" },
  { id: 4, amount: 50, date: "2024-02-04", to: "Arora" },
...
const Home = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image
        source={{ uri: "https://i.ytimg.com/vi/o39gOhbTZfs/maxresdefault.jpg" }}
